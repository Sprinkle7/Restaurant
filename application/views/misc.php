        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 pad">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-user"> </i> Misc Items
                            </li>
            ...
            <div class="panel panel-default">
                    <div class="panel-heading" style="background:#FDA018; color:#fff;">
                        ...
                        <?php echo form_open(base_url().'rest/addmisc')?>
                            <table class="table table-hover">
                                    ...
                                    <tr class="odd">
                                        <td></td>
                                        <td><input type="submit" name="itema" value="Add Item" class="btn btn-warning"></td>
                                    </tr>
                                </table>
                        <?php echo form_close();?>  
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <?php  if (!empty($misc)) {
                        ...
                        <tr class="odd">
                            ...
                            <td>
                            <a href="<?php base_url()?>emisc/<?php echo $row->m_id;?>"><span class="fa fa-pencil"> </span> </a>&nbsp;
                            <a href="<?php base_url()?>umisc/<?php echo $row->m_id;?>"><span class="glyphicon glyphicon-trash"> </span> </a>
                            </td>
                        </tr>
                        <?php $k++;  }}else{ echo "No Misc Items<br/>";}?>
                    </table>
                    </div>
                </div>
            </div>    
