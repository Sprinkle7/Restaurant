        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                    <div class="panel-heading" style="background:#FDA018; color:#fff;">
                        ...
                        <?php echo form_open(base_url().'rest/updateitem')?>
                            <table class="table table-hover">
                                    <tr class="odd">
                                    <?php  $ki = $items->item_name; ?>
                                        <td>Item Name</td>
                                        <td><?php echo form_input('name',$ki,'class="form-control" required="required"')?></td>
                                    </tr>
                                     <tr class="odd">
                                    <?php  $kk = $items->item_price; ?>
                                        <td>Item Name</td>
                                        <td><?php echo form_input('price',$kk,'class="form-control" required="required"')?></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><input type="hidden" name="id" value="<?php echo $items->id;?>"><input type="submit" name="upitem" value="Modify" class="btn btn-warning"></td>
                                    </tr>
                                </table>
                        <?php echo form_close();?>  
                        </div>
